...
profile:
  align: right
  image: building_img.jpg # 연구실 단체사진이나 로고 파일명으로 변경 가능
  image_circular: false
  address: >
    <p>College of Pharmacy</p>
    <p>Kangwon National University</p>
    <p>Chuncheon 24341, Republic of Korea</p>

news: true # 뉴스(공지사항) 섹션을 활성화합니다.
selected_papers: true # Selected Publications 섹션을 활성화합니다.
social: true # 하단 소셜 아이콘을 표시합니다.
---
